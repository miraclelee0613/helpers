                    ...
                    <ul class="content-list">
                        <li class="content-item">
                            <a href="" class="content-item-link">
                                <div class="content-item-container">
                                    <div class="collapsed">
                                        <div class="line-clamp" style="max-height: 3rem; line-height: 1.5; -webkit-line-clamp: 2;">
                                            <p class="content-title">제가 도와드릴게요!</p>
                                        </div>
                                    </div>
                                    <div class="collapsed">
                                        <div class="line-clamp">
                                            <p class="content">코딩을 배우고 싶습니다</p>
                                        </div>
                                    </div>
