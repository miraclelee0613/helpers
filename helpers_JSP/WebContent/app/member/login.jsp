...
<body scroll="No">
    <div class="container px-2">
        <!-- 컨테이너\헤더1 -->
        <header class="header column is-three-fifths-widescreen is-two-thirds-desktop is-three-quarters-tablet">
            <!-- 헤더1 -->
            <div class="header-all">
                ...
                <div class="header-left">
                    ...
                    <!-- 네비바 -->
                    <nav>
                        <ul class="header-ul is-size-7-mobile">
                            ...
                            <li class="header-left-item header-item is-hidden-mobile is-hidden">
                                <a href="">소개글</a>
                            </li>
                        </ul>
                    </nav>
                ...
                <div class="header-right">
                    <nav>
                        <ul class="header-ul">
                            <li class="header-right-item header-item is-size-7-mobile">
