...
<body scroll="No">
    <!-- ====================================헤더(공통)============================= -->
    <header class="header column is-three-fifths-widescreen is-half-desktop is-three-quarters-tablet">
        <div class="header-all" style="max-width: 560px;">

            <div class="header-left is-size-7-mobile">
                ...
                <nav>
                    ...
                    <ul class="header-ul">
                        <li class="header-left-item header-item is-size-7-mobile">
                            <a href="">커뮤니티</a>
                        </li>
                        <li class="header-left-item header-item is-hidden-mobile">
                            <a href="">문의하기</a>
                        </li>
                        <li class="header-left-item header-item is-hidden">
                            <a href="">소개글</a>
                        </li>
                    </ul>
            ...
            <div class="header-right is-size-7-smobile">
                <nav>
                    <ul class="header-ul">
