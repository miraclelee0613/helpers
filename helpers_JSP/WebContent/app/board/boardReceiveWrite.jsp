...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/board/boardWrite.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/index/index.css">
<link rel="stylesheet"
		...
		<div class="write-detail">
			<div class="write-header">
				<div class="write-header-wrapper">
					...
					</select> <span class="write-title">도움주기 페이지</span>
			...
			<div class="write-body">
				<div class="write-body-wrapper">
					...
					<div class="write-contents">
						<span class="write-contents-text"> <textarea
								name="write-content" class="write-contents-textarea"
								placeholder="글 작성에 대한 공지사항"></textarea>
						</span>
					</div>
				</div>
			</div>
